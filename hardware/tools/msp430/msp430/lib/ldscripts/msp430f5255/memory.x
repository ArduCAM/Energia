MEMORY {
  ...
  ram (wx)         : ORIGIN = 0x2400, LENGTH = 0x8000 /* END=0xa400, size 32K */
  rom (rx)         : ORIGIN = 0xa400, LENGTH = 0x5b80 /* END=0xff80, size 23424 */
  vectors          : ORIGIN = 0xff80, LENGTH = 0x0080 /* END=0x10000, size 128 as 64 2-byte segments */
  far_rom          : ORIGIN = 0x00010000, LENGTH = 0x0001a400 /* END=0x0002a400, size 105K */
