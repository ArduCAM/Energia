MEMORY {
  ...
  infomem          : ORIGIN = 0x1000, LENGTH = 0x0400 /* END=0x1400, size 1K as 1 1024-byte segments */
  infoa            : ORIGIN = 0x1000, LENGTH = 0x0400 /* END=0x1400, size 1K */
...
PROVIDE (__info_segment_size = 0x400);
PROVIDE (__infoa = 0x1000);
